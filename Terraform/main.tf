...
resource "aws_security_group" "alb_sg" {
  ...
  description = "Security Group para el ALB. Acepta HTTP desde CloudFront y desde internet"
  vpc_id      = aws_vpc.main.id
...
# Nota: para CloudFront -> ALB en texto plano, se usa HTTP en el listener del ALB.
# Si luego quieres terminar TLS en CloudFront y mantener HTTP interno, esa parte se configura en CloudFront y no en este ALB.

# ============================================================
# 7. ECS CLUSTER Y DESPLIEGUE
# ============================================================
